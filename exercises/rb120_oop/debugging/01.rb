...
# Invoking `#books` returns an array of book objects, instead of a single book object.
# Therefore, invoking `#display_data` on the returned array raises a `NoMethodError`.
