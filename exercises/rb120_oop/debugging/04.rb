...
class Employee
  ...
  # Since the getter method for the `@serial_number` instance variable is private, it cannot be invoked on an object other than the current instance.
  # Therefore, a `NoMethodError` error is raised when `#==` is invoked since `#serial_number` is not accessible by the object referenced by `other`.
  # To fix the error, the getter method `#serial_number` should reassigned as a protected method instead.
