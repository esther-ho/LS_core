...
def dot_separated_ip_address?(input_string)
  ...
  # alternative: `return false unless dot_separated_words.size == 4`

  while dot_separated_words.size > 0 do
    word = dot_separated_words.pop
    return false unless is_an_ip_number?(word)
  end
  # Original code doesn't return false for non-numeric component.
  # It used break, and control falls to the `return true` statement.
